...
L=f.readlines()
f.close()
f1=TFile("radion_bias_1.root","RECREATE")
...
for lines in L:
    ...
    m=lines.split()[1]
    mu_inj="1.00"
    treename="higgsCombineDoubleHTag_"+icat+"_13TeV.Radion"+m+"_18_01_2021.t0.mu_inj"+mu_inj+"_envelop.MultiDimFit.mH125.123456.root"
